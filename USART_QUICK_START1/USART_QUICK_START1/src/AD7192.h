...
#define ACX_EN					0x400000
#define ACX_DIS					0x000000
...
#define	NOP						0x00									
 ...
 #define DATA_COLLECTED 15

 int64_t col_data[DATA_COLLECTED];
 int64_t col_data_ADC1[DATA_COLLECTED];
 int64_t col_data_ADC0[DATA_COLLECTED];
